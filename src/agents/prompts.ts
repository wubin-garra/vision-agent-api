...
- 先定位掌心矩形（拇指球到小指侧、手腕到指根），再在掌心内描摹；手指区域不要当作掌心纹起点
- 每条线 6–8 个点，相邻点沿真实纹路连续弯曲，禁止三点直线硬连、禁止四条线共用同一套模板
- heart：掌上部横沟，通常从小指侧下方走向食指与中指之间
- head：掌中部横沟，常从虎口/食指侧向小指侧延伸，多位于感情线下方
- life：环绕拇指丘的弧沟，从虎口附近弯向腕部
- career：掌心纵向竖沟，从腕部附近向中指方向上升（弱/断仍沿可见段）
- 线浅时 path 仍贴最近似沟壑，并在 description 说明深浅
