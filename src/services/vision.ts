...
const CAPTION_PROMPT_FAST = `用 3–5 句中文简要描述这张图片，供后续路由与分析：
- 主体/场景是什么（包装类请写清：可食用零食 / 盘装正餐 / 日化清洁或管道疏通等非食品 / 其他）
- 关键可见文字请尽量点出品名与警示词（如疏通、腐蚀、配料表、营养成分）；米饭类请点明米粒「粒粒分明偏干」或「黏连奶油/酱汁感」
- 颜色与环境线索
